...
def savecluster(sampleid,name,ctype,cells,comment,marks,negmarks):
	...
	if clstrcount == 0:
		...
		db.cluster.insert_one({"mapid":sampleid,"clstrName":name,"clstrType":ctype,"color":color,"cells":cells,"comment":comment,"x" : "", "y" : "", "label" : False, "prerender" : False,"marks":marks,"negmarks":negmarks})
